                        ...
                        <form method="post" name="myForm" id="myForm" onsubmit="return validateForm()">
                            ...
                            <div class="grid lg:grid-cols-12 grid-cols-1 gap-3">
                                <div class="lg:col-span-6">
                                    <label for="name" class="font-semibold">Tên của bản:</label>
                                    <input name="name" id="name" type="text" class="mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-100 dark:border-gray-800 focus:ring-0" placeholder="Tên :">
                                </div>
                                ...
                                <div class="lg:col-span-12">
                                    ...
                                    <input name="subject" id="subject" class="mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-100 dark:border-gray-800 focus:ring-0" placeholder="Câu hỏi :">
                                </div>

                                <div class="lg:col-span-12">
                                    <label for="comments" class="font-semibold">Ý kiến của bạn:</label>
                                    <textarea name="comments" id="comments" class="mt-2 w-full py-2 px-3 h-28 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-100 dark:border-gray-800 focus:ring-0" placeholder="Ý kiến :"></textarea>
                                </div>
                            </div>
                            <button type="submit" id="submit" name="send" class="py-2 px-5 inline-block tracking-wide align-middle duration-500 text-base text-center bg-red-500 text-white rounded-md mt-2">Gửi phản hồi</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-6">
            ...
            <div class="text-center px-6">
                ...
                <div class="content mt-7">
                    ...
                    <div class="mt-5">
                        <a href="tel:+152534-468-854" class="text-red-500 font-medium">+{{$khach_san->so_dien_thoai}}</a>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center px-6">
                ...
                <div class="content mt-7">
                    ...
                    <div class="mt-5">
                        <a href="mailto:contact@example.com" class="text-red-500 font-medium">{{$khach_san->email}}</a>
                    </div>
                </div>
            </div>
