        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
            ...
            <div class="group relative overflow-hidden" >
                <div class="relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                    <img src="{{Storage::url($item->anh)}}" class="group-hover:scale-110 group-hover:rotate-3 duration-500" alt="">
                ...
                <div class="mt-6">
                    ...
                    <a href="blog-detail.html" class="text-lg font-medium hover:text-red-500 duration-500 ease-in-out">{{$item->tieu_de}}</a>
                    <p class="text-slate-400 mt-2">{{$item->mo_ta_ngan}}</p>

                    <div class="mt-3">
                        <a href="<?= env('APP_URL') ?>/chi_tiet_tin_tuc/<?= $item->id ?>" class="hover:text-red-500 inline-flex items-center">Chi tiết<i data-feather="chevron-right" class="size-4 ms-1"></i></a>
                    </div>
                </div>
            </div><!--end content-->
            @endforeach
