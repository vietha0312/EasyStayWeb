...
<main class="app-main">
    ...
    <form class="mx-3" action="{{route('admin.loai_phong.update',$loai_phong)}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('put')
        ...
        <img width="150px" src="{{Storage::url($loai_phong->anh)}}" alt=""> <br>
