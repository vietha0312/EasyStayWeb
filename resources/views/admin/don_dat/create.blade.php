                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            ...
                            <form action="{{ route('admin.don_dat.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mb-3 mx-auto w-50">
                                    ...
                                    <label for="trang_thai"
                                        class="form-label">Đã xác nhận</label>

                                    <input type="radio" name="trang_thai" id="trang_thai-2"
                                        value="{{ \App\Models\Don_dat::CHO_XAC_NHAN }}">
                                    <label for="trang_thai"
                                        class="form-label">Chờ xác nhận</label>
                                </div>

                                <div class="d-flex justify-content-center mb-3">
                                    <a href="{{ route('admin.don_dat.index') }}" class="btn btn-warning">Back</a>
